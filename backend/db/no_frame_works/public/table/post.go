...
func newPostTableImpl(schemaName, tableName, alias string) postTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, TitleColumn, ContentColumn, AuthorIDColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns  = postgres.ColumnList{TitleColumn, ContentColumn, AuthorIDColumn, CreatedAtColumn, UpdatedAtColumn}

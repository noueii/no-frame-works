...
func (h *Handler) PutEditUsername(
	ctx context.Context,
	request oapi.PutEditUsernameRequestObject,
) (oapi.PutEditUsernameResponseObject, error) {
	...
	if err != nil {
		...
		if errors.Is(err, user.ErrUsernameTaken) {
			return oapi.PutEditUsername409JSONResponse{
				Error: "username is already taken",
			}, nil
		}
		return oapi.PutEditUsername400JSONResponse{

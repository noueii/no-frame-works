...
REQUIRED_DIRS=("handler/http" "service" "domain" "middleware")
REQUIRED_FILES=("api.go" "repository.go" "permissions.go" "handler/http/handler.go" "handler/http/routes.go" "service/service.go" "middleware/permission.go")
